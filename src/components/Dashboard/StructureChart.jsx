      ...
      <div className="flex items-end justify-around h-44 border-b border-slate-100 pb-2 relative">
        ...
        <div className="flex flex-col items-center w-20 group">
          ...
          <div 
            ...
            className="w-12 bg-blue-600 rounded-t-xl transition-all duration-700 ease-out shadow-lg shadow-blue-100 group-hover:bg-blue-700"
          ></div>
        ...
        <div className="flex flex-col items-center w-20 group">
          ...
          <div 
            ...
            className="w-12 bg-blue-500 rounded-t-xl transition-all duration-700 ease-out shadow-lg shadow-blue-100 group-hover:bg-blue-600"
          ></div>
        ...
        <div className="flex flex-col items-center w-20 group">
          ...
          <div 
            ...
            className="w-12 bg-slate-400 rounded-t-xl transition-all duration-700 ease-out shadow-lg shadow-slate-100 group-hover:bg-slate-500"
          ></div>
